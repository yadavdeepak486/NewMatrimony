...
@Component({
  selector: 'app-featured-member',
  templateUrl: './featured-member.component.html',
...
export class FeaturedMemberComponent implements OnInit {
  ...
  getfeaturesusers() {
    this.adminService.getfeaturesusers().subscribe(
      (response: any) => {
