...
export class MemberLanguageComponent implements OnInit {
  ...
  getonelanguage(id) {
    this.adminService.getonelanguage(id).subscribe(
      (response: any) => {
        console.log(id);
        console.log(response);
        this.editmode = true;
        this.selectedlanguage = response.data;
        this.editlanguage.setValue({
  ...
  updatelanguage() {
    ...
    this.adminService
      .editlanguage(this.editlanguage.value.id, this.editlanguage.value)
      .subscribe(
        (response: any) => {
          this.getalllanguage();
  ...
  submitForm() {
    ...
    this.adminService.addlanguage(this.language.value).subscribe(
      (response: any) => {
        console.log(response);
